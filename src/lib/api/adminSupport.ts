...
export const adminSupportApi = {
  ...
  reply: (id: string, content: string, attachments?: UploadedAttachment[], attachmentUrls?: string[]) =>
    api.post<Envelope<{ message: MessageDTO }>>(`/admin/support/conversations/${id}/reply`, {
      content,
      attachments,
      attachmentUrls,
    }),
