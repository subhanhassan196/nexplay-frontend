    ...
    <div className="container-nexplay section-padding pt-28 sm:pt-32">
      ...
      {isLoading ? (
        ...
        <GlassPanel className="overflow-hidden">
          <div className="grid grid-cols-[32px_1fr_auto_auto] gap-2 border-b border-white/10 px-3 py-3 sm:grid-cols-[48px_1fr_auto_auto] sm:gap-4 sm:px-5 text-xs font-medium uppercase tracking-wide text-muted">
            <span>#</span>
            <span>Player</span>
          ...
          {entries.map((entry) => (
            <div
              key={entry.userId}
              className="grid grid-cols-[32px_1fr_auto_auto] items-center gap-2 border-b border-white/5 px-3 py-3 sm:grid-cols-[48px_1fr_auto_auto] sm:gap-4 sm:px-5 sm:py-3.5 transition-colors last:border-0 hover:bg-white/[0.03]"
            >
              <span
                className={cn(
